...
class Webtex_Weddingregistry_Block_Adminhtml_Products_Add_Add extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('sales')->__('Save'));
        ...
        $confirm = Mage::helper('sales')->__('Are you sure you want to cancel adding?');
    ...
    public function getHeaderHtml()
    {
        $out = '<div id="order-header">'
            .  '<h3 class="icon-head head-sales-order"> Add Products To Registry</h3>'
            . '</div>';
        return $out;
    }
