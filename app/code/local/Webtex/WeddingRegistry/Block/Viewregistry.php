...
class Webtex_WeddingRegistry_Block_Viewregistry extends Mage_Core_Block_Template
{
    private $_productCollection = null;
    private $_countPurchasedProducts = 0;
    
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('webtexweddingregistry/viewregistry.phtml');
    }
    ...
    public function getRegistrantTitle()
    {
        ...
        $answer .= ', '.$this->__('Welcome to Your Wedding Registry!');
    ...
    public function getProducts()
    {
        ...
        {
            $this->_productCollection = Mage::helper('webtexweddingregistry')->getItemsCollection();                        
        }
    ...
    public function getPriorityList($_id)
    {
        ...
        {
           $_answer .= '<option value="' . $key . '"';
           $_answer .= $_id == $key ? ' selected="selected"' : '';         
           $_answer .= '>' . $val;
           $_answer .= '</option>';
        }
